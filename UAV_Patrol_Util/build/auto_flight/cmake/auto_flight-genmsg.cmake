...
message(STATUS "auto_flight: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iauto_flight:/home/andrew/NCRL/UAV_Patrol/UAV_Patrol_Util/src/auto_flight/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/andrew/NCRL/UAV_Patrol/UAV_Patrol_Util/src/auto_flight/msg/ncrl_link.msg" NAME_WE)
add_custom_target(_auto_flight_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "auto_flight" "/home/andrew/NCRL/UAV_Patrol/UAV_Patrol_Util/src/auto_flight/msg/ncrl_link.msg" ""
)
...
### Generating Messages
_generate_msg_cpp(auto_flight
  "/home/andrew/NCRL/UAV_Patrol/UAV_Patrol_Util/src/auto_flight/msg/ncrl_link.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_lisp(auto_flight
  "/home/andrew/NCRL/UAV_Patrol/UAV_Patrol_Util/src/auto_flight/msg/ncrl_link.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_nodejs(auto_flight
  "/home/andrew/NCRL/UAV_Patrol/UAV_Patrol_Util/src/auto_flight/msg/ncrl_link.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/auto_flight)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/auto_flight\")")
  # install generated code
  install(
